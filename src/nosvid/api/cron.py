...
def create_job(job: CronJobCreate, scheduler: SchedulerService = Depends(get_scheduler_service)):
    """
...
def update_job(job_id: str, job: CronJobUpdate, scheduler: SchedulerService = Depends(get_scheduler_service)):
    """
    Update a cron job
    """
