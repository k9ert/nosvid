...
def update_platform_metadata(main_metadata: Dict[str, Any], platform: str, platform_metadata: Dict[str, Any]) -> Dict[str, Any]:
    """
...
def get_platform_metadata(main_metadata: Dict[str, Any], platform: str) -> Dict[str, Any]:
    """
