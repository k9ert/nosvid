...
class Video:
    ...
    def from_dict(cls, data: Dict[str, Any]) -> 'Video':
        ...
        nostr_posts = []
        if 'platforms' in data and 'nostr' in data['platforms'] and 'posts' in data['platforms']['nostr']:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if 'nostr' in platforms_dict and self.nostr_posts:
            ...
            platforms_dict['nostr']['posts'] = [post.to_dict() for post in self.nostr_posts]
