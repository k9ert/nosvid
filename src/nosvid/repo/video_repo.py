...
from ..utils.filesystem import setup_directory_structure, get_video_dir, load_json_file, save_json_file
...
class VideoRepo(ABC):
    ...
    def list(self,
             ...
             sort_order: str = "desc") -> List[Video]:
        """
...
class FileSystemVideoRepo(VideoRepo):
    ...
    def get_by_id(self, video_id: str, channel_title: str) -> Optional[Video]:
        ...
        channel_metadata_files = glob.glob(os.path.join(metadata_dir, 'channel_videos_*.json'))
