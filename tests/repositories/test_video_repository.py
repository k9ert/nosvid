...
from src.nosvid.repositories.video_repository import FileSystemVideoRepository

class TestFileSystemVideoRepository(unittest.TestCase):
    """Tests for the FileSystemVideoRepository"""
    
    def setUp(self):
        """Set up the test environment"""
        # Create a temporary directory for testing
        self.temp_dir = tempfile.mkdtemp()
        self.repo = FileSystemVideoRepository(self.temp_dir)
    ...
    def test_list_with_sorting(self):
        ...
        videos = self.repo.list(self.channel_title, sort_by="published_at", sort_order="asc")
        ...
        videos = self.repo.list(self.channel_title, sort_by="duration", sort_order="desc")
    ...
    def test_update(self):
        ...
        self.assertEqual(updated_video.platforms["youtube"].url, "https://youtube.com/watch?v=video1")
        self.assertTrue(updated_video.platforms["youtube"].downloaded)
        self.assertEqual(updated_video.platforms["youtube"].downloaded_at, "2023-01-01T12:00:00")
