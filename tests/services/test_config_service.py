...
class TestConfigService(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # Create test config
        self.test_config = {
            "youtube": {"api_key": "test_api_key"},
            "nostr": {"nsec": "test_nsec", "npub": "test_npub"},
            "defaults": {"output_dir": "./test_repository"},
    ...
    def test_get(self):
        ...
        self.assertEqual(
            self.config_service.get("youtube"), {"api_key": "test_api_key"}
        )
